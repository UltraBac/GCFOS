...
class OpenStackRepository : virtual public Repository
	{
public:
	virtual ~OpenStackRepository();
...
private:
	gcroot<net::openstack::Core::Providers::IIdentityProvider ^> m_IdentityProvider;
	gcroot<net::openstack::Core::Domain::CloudIdentityWithProject ^> m_Identity;
	gcroot<net::openstack::Core::Domain::UserAccess ^> m_User;
	gcroot<net::openstack::Providers::Rackspace::CloudFilesProvider ^> m_Files;
